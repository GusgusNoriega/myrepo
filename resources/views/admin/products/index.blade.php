    ...
    <form id="productForm" class="rounded-2xl border border-gray-200 bg-white p-4 space-y-6">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <input id="featured_media_id" name="featured_media_id" type="hidden"
                 class="mt-1 w-full rounded-xl border border-gray-200 px-3 py-2 text-sm" placeholder="Ej: 10"
                 value=""
                 data-mm="image"           
...
<script>
  ...
  const F = {
    ...
    has_variants:       document.querySelector('#has_variants'),
    price_cents:        document.querySelector('#price_cents'),
    cost_cents:         document.querySelector('#cost_cents'),
    compare_at_price_cents: document.querySelector('#compare_at_price_cents'),
    currency:           document.querySelector('#currency'),
    tax_included:       document.querySelector('#tax_included'),
    attributes:         document.querySelector('#attributes'),
    dimensions:         document.querySelector('#dimensions'),
    published_at:       document.querySelector('#published_at'),
    featured_media_id:  document.querySelector('#featured_media_id'),
